...
public class OmGenertorOld {
    ...
    public static void main(String[] orgs){
        ...
        dsc.setPassword("chen123");
        dsc.setUrl("jdbc:mysql://localhost:3306/om?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
